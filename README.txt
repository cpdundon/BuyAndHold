Buy and Hold Project Description:

This project will establish the power of buy and hold investing.  A user's portfolio is matched up against a simple no fee index based portfolio.  The index portfolio is easy to implement via a discount broker.
...
Concluding finally: reconcile the user portfolio's total IRR against the SPY/cash total IRR.  We are comparing apples to apples as they both have the same risk.  I am betting that 90% of the time that the SPY/cash portfolio outperforms.
